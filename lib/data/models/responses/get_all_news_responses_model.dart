...
class GetAllNewsResponseModel {
  ...
  factory GetAllNewsResponseModel.fromJson(String str) =>
      GetAllNewsResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetAllNewsResponseModel.fromMap(Map<String, dynamic> json) =>
      GetAllNewsResponseModel(
        status: json["status"],
